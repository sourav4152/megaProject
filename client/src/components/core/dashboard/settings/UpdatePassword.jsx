            ...
            <form onSubmit={handleSubmit(submitPasswordForm)}>
                <div className='my-5 rounded-md border border-richblack-700 bg-richblack-800 p-8 px-12'>
                    ...
                    <div className='flex flex-col lg:flex-row gap-5' >
                        ...
                        <div className='relative flex flex-col gap-x-2 w-full' >
                            <label htmlFor="newPassword" className='label-style uppercase tracking-wider mb-1' >Confirm New Password <span className='text-pink-100'>*</span></label>
                            <input
                            ...
                            {
                                errors.confirmPassword && <p className='input-error-style' >{errors.confirmPassword?.message}</p>
                            }
                        </div>
