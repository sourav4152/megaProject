...
const CourseInformationForm = () => {
    ...
    // Corrected the destructuring of setStep, setCourse from useSelector
    ...
    useEffect(() => {
        ...
        // MODIFIED: Corrected field names for consistency with backend
    ...
    const isFormUpdated = () => {
        ...
        // MODIFIED: Simplified conditions and corrected property names to match the backend
        if (
            ...
            currentValues.instruction.toString() !== course.instruction.toString() || // Corrected name
        ...
        if (editCourse) {
            if (isFormUpdated()) {
                ...
                if (currentValues.instruction.toString() !== course.instruction.toString()) {
                    formData.append("instruction", JSON.stringify(data.instruction)); // Corrected name
                }
