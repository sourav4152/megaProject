...
const VideoDetailsSidebar = ({ setReviewModal }) => {
    ...
    const [_, setActiveStatus] = useState(null);
    ...
    return (
        <>
            <div className={`${showSidebar ? "" : "hidden"} w-6 h-72 md:hidden absolute self-center`}>
                <FaChevronRight onClick={() => { setShowSidebar(!showSidebar); }} className={` md:hidden z-100 cursor-pointer text-2xl text-richblack-900 m-2 bg-richblack-100 rounded-full p-1 top-3 absolute left-0`} />
            </div>
