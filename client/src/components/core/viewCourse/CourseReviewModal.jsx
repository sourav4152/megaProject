...
export default function CourseReviewModal({ setReviewModal }) {
  ...
  // MODIFIED: Removed the local `courseRating` state
  // We will manage the rating state solely through `react-hook-form`
  ...
  return (
    <div className="fixed inset-0 z-[1000] !mt-0 grid h-screen w-screen place-items-center overflow-auto bg-transparent backdrop-blur-sm">
        ...
        <div className="p-6">
          ...
          >
            <ReactStars
              ...
              edit={true}
              starSelectingHoverColor="#E7C000"
